...
Explore
 @ishitj Sign out
0
0 2 Ashishgup1/SocketProgramming
 Code  Issues 0  Pull requests 0  Projects 0  Wiki  Insights
SocketProgramming/app.js
ea10d77  4 days ago
@sankalp-sangle sankalp-sangle Updated app.js
@Ashishgup1 @sankalp-sangle @ishitj
     
227 lines (179 sloc)  4.43 KB
...
io.sockets.on('connection', (socket) => {
    ...
    socket.on('new_message', async (data) => {
        ...
        else if(msg.substr(0,5)=="send ")
        {
            ...
            var usrname=usr[1];
            var amt=usr[2];
            users[usrname].emit('new_message', {
                message: socket.username+" wants to send you " + amt +" ZFC in exchange of the data ,do you want to proceed with the transaction?(Press Y/N)",
                username: "Liveweaver"
            });
